...
#ifndef XPLORE_SWIFT_H
#define XPLORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Xplore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Xplore11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC6Xplore12CategoryView")
...
@class NSString;
SWIFT_CLASS("_TtC6Xplore23FavouritesTableViewCell")
...
@class NSBundle;
SWIFT_CLASS("_TtC6Xplore24FavouritesViewController")
...
@class UITableView;
@class NSIndexPath;
@interface FavouritesViewController (SWIFT_EXTENSION(Xplore)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC6Xplore15LocationService")
...
@class CLLocation;
@interface LocationService (SWIFT_EXTENSION(Xplore)) <CLLocationManagerDelegate>
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC6Xplore13SceneDelegate")
